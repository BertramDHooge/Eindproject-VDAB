...
//    weak open var prefetchDataSource: UITableViewDataSourcePrefetching?
    ...
    override func viewDidLoad() {
        ...
        let infoMammoth = Contact(name: mammothName, address: adressMammoth, telephoneNumber: "123456789", emailAddress:
            "imAMammoth@cold.com")
        let mammothCrops = [Stock(portions: Portion(stockType: FoodTypes.fruit, stockName: FoodName.apples, quantityTypes: QuantityTypes.kg, quantity: Quantity._20, sellingPrice: 22), amountOfCropPortionsAvailable: 2000, amountOfCropsSelected: 0, totalCostOfCropsSelected: 0.0)]
        ...
        let bertramCrops = [Stock(portions: Portion(stockType: FoodTypes.meat, stockName: FoodName.deer, quantityTypes: QuantityTypes.kg, quantity: Quantity._10, sellingPrice: 22), amountOfCropPortionsAvailable: 20, amountOfCropsSelected: 0, totalCostOfCropsSelected: 10.0), Stock(portions: Portion(stockType: FoodTypes.fruit, stockName: FoodName.apples, quantityTypes: QuantityTypes.kg, quantity: Quantity._20, sellingPrice: 50), amountOfCropPortionsAvailable: 100, amountOfCropsSelected: 0, totalCostOfCropsSelected: 0.0), Stock(portions: Portion(stockType: FoodTypes.vegetable, stockName: FoodName.carrots, quantityTypes: QuantityTypes.bussel, quantity: Quantity._10, sellingPrice: 10), amountOfCropPortionsAvailable: 20, amountOfCropsSelected: 0, totalCostOfCropsSelected: 0.0)]
        
        let veltWinkelCrops = [Stock(portions: Portion(stockType: FoodTypes.vegetable, stockName: FoodName.tomatoes, quantityTypes: QuantityTypes.grams, quantity: Quantity._100, sellingPrice: 5.0), amountOfCropPortionsAvailable: 20, amountOfCropsSelected: 0, totalCostOfCropsSelected: 0.0)]
        ...
        let veltWinkelCrops = [Stock(portions: Portion(stockType: <#T##FoodTypes#>, stockName: <#T##FoodName#>, quantityTypes: <#T##QuantityTypes#>, quantity: <#T##Quantity#>, sellingPrice: <#T##Double#>), amountOfCropPortionsAvailable: <#T##Int#>, amountOfCropsSelected: <#T##Int#>, totalCostOfCropsSelected: <#T##Double#>)]
