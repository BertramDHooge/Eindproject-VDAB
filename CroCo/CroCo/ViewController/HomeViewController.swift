...
//        producerReference?.setValue(["companyName":"Veltwinkel"])
        ...
        let mammothCrops = [Stock(portion: Portion(cropType: FoodTypes.fruit, cropName: FoodName.tomatoes, standardisedQuantitySingleCropType: QuantityTypes.kg, quantity: Quantity._1, sellingPrice: 2.0), amountOfCropPortionsAvailable: 50, amountOfCropsSelected: 0, totalCostOfCropsSelected: 0.0)]
//        (cropType: FoodTypes.fruit, cropName: FoodName.apples, quantityTypes: QuantityTypes.kg, quantity: Quantity._20, sellingPrice: 22, amountOfCropPortionsAvailable: 2000, amountOfCropsSelected: 0, totalCostOfCropsSelected: 0.0)]
        ...
        let bertramCrops = [Stock(portion: Portion(cropType: FoodTypes.meat, cropName: FoodName.deer, standardisedQuantitySingleCropType: QuantityTypes.kg, quantity: Quantity._5, sellingPrice: 5.0), amountOfCropPortionsAvailable: 10, amountOfCropsSelected: 0, totalCostOfCropsSelected: 0.0), Stock(portion: Portion(cropType: FoodTypes.fruit, cropName: FoodName.apples, standardisedQuantitySingleCropType: QuantityTypes.kg, quantity: Quantity._1, sellingPrice: 1.50), amountOfCropPortionsAvailable: 100, amountOfCropsSelected: 0, totalCostOfCropsSelected: 0.0)]
        ...
        let veltWinkelCrops = [Stock(portion: Portion(cropType: FoodTypes.vegetable, cropName: FoodName.carrots, standardisedQuantitySingleCropType: QuantityTypes.bussel, quantity: Quantity._10, sellingPrice: 3.0), amountOfCropPortionsAvailable: 30, amountOfCropsSelected: 0, totalCostOfCropsSelected: 0.0)]
